...
public class JWTCreator {
    ...
    public static JWTObject create(String token, String prefix, String key)
        ...
        object.setSubject(claim.getSubject());
        object.setExpiration(claim.getExpiration());
        object.setIssuedAt(claim.getIssuedAt());
        object.setRoles(String.valueOf((List) claim.get(ROLES_AUTHORITIES)));
        return object;
    }
